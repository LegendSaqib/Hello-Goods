...
import tacos from '../assets/tacos.webp'; // Ensure this image is correctly imported
import { FaUtensils, FaClock, FaSeedling, FaArrowRight, FaArrowLeft } from "react-icons/fa";
  ...
  return (
    <>
      <div className="flex flex-col bg-[yellow] lg:flex-row w-full items-center lg:items-start relative">
        ...
        {/* Image Section */}
        <div className="relative w-full lg:w-1/2 p-4 lg:p-8">
      ...
      <div className="flex justify-between mb-12 mt-4 px-24">
      <Link to="/"><button 
